...
long i3_handle_position_won_in_3(short a, short b, short c, short d, short e, short f, short g, short h, FILE * fp, short undoneMove) {
	long position;
...
long i3_handle_position_lost_in_2(short a, short b, short c, short d, short e, short f, short g, short h, FILE * fp, short undoneMove) {
	long count = 0;
	short tmp, org, dst;
	...
	undo_all_moves(
		...
		count += i3_handle_position_won_in_3(a, b, c, d, e, f, g, h, fp, undoneMove);
	)
	return count;
}

long i3_handle_position_won_in_1(short a, short b, short c, short d, short e, short f, short g, short h, FILE * fp, short undoneMove) {
	long count = 0;
	short tmp, org, dst;
	...
	undo_all_moves(
		...
		count += i3_handle_position_lost_in_2(a, b, c, d, e, f, g, h, fp, undoneMove);
	)
	return count;
}

long i3_handle_won_position(short a, short b, short c, short d, short e, short f, short g, short h, FILE * fp) {
	long count = 0;
	short org, dst, undoneMove;
	undo_all_win_moves(
		// In here every position is won with one ply
		count += i3_handle_position_won_in_1(a, b, c, d, e, f, g, h, fp, undoneMove);
	)
	return count;
}

// All 4 seeds find 463.954.854 results
void * iteration3(void * seedPointer) {
	...
	generate_won_positions(seed,
		count += i3_handle_won_position(a, b, c, d, e, f, g, h, fp);
	)
